...
const styles = StyleSheet.create({
  ...
  filterChipActive: { backgroundColor: "rgba(225,29,42,0.18)", borderColor: "#FF1F1F" },
  filterText: { color: "#9a9a9a", fontWeight: "800", fontSize: 12 },
  ...
  statusText: { color: "#7a7a7a", fontSize: 11, fontWeight: "700" },
  ...
  ballNum: { fontSize: 18, fontWeight: "900" },
