...
const styles = StyleSheet.create({
  ...
  siteToggleText: { color: "#fff", fontSize: 14, fontWeight: "800", flex: 1, letterSpacing: 0.3 },
  chev: { color: "#9a9a9a", fontSize: 12 },
  checkMark: { color: "#FF1F1F", fontSize: 18, fontWeight: "900" },
  reloadBtn: {
    width: 42,
    height: 42,
    borderRadius: 11,
  ...
  autoLabel: { color: "#c9c9c9", fontSize: 11, fontWeight: "900", letterSpacing: 0.4 },
  autoBanner: {
    backgroundColor: "rgba(225,29,42,0.18)",
    paddingHorizontal: 12,
    paddingVertical: 8,
    borderBottomWidth: 1,
    borderBottomColor: "rgba(225,29,42,0.4)",
  },
  autoBannerText: { color: "#ffb84a", fontSize: 11, fontWeight: "800", textAlign: "center", letterSpacing: 0.3 },
  switcher: {
    backgroundColor: "#0e0e10",
    borderBottomWidth: 1,
    borderBottomColor: "rgba(255,255,255,0.06)",
  ...
  switcherLabel: { color: "#fff", fontSize: 14, fontWeight: "800" },
  ...
  fabText: { color: "#fff", fontWeight: "900", fontSize: 14, letterSpacing: 0.4 },
  statusPill: {
    position: "absolute",
    left: 16,
    right: 16,
    backgroundColor: "rgba(13,51,32,0.95)",
    borderColor: "rgba(31,122,71,0.6)",
    borderWidth: 1,
    paddingHorizontal: 14,
    paddingVertical: 11,
    borderRadius: 12,
  },
  statusText: { color: "#a8efc6", fontSize: 13, fontWeight: "800", textAlign: "center" },
  webFallback: { alignItems: "center", justifyContent: "center", padding: 24, gap: 12 },
  webTitle: { color: "#fff", fontSize: 22, fontWeight: "900", marginTop: 8 },
  ...
  webLinkText: { color: "#fff", fontWeight: "800", fontSize: 14 },
});
